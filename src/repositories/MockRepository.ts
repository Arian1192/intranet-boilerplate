...
export class MockRepository implements Repository {
  ...
  async getBookingDashboard(): Promise<BookingDashboard> {
    // Espejo del live (barrido 29 jul 2026).
    return this.delay({
      kpis: [
        { id: '1', label: 'TENTATIVE', amount: 11433.78, count: 12, status: 'tentative' },
        { id: '2', label: 'CONFIRMADO', amount: 11100, count: 9, status: 'confirmed' },
        { id: '3', label: 'CONTRATO', amount: 0, count: 0, status: 'contract' },
        { id: '4', label: 'PENDIENTE COBRO', amount: 800, count: 1, status: 'pending-payment' },
        { id: '5', label: 'PENDIENTE LIQUIDAR', amount: 6150, count: 6, status: 'pending-settlement' },
        { id: '6', label: 'LIQUIDADO', amount: 1000, count: 1, status: 'done' },
      ],
      fichasRevisar: { artistas: 40, datos: 111, documentos: 50, bios: 33 },
      posiblesGigs: [
        {
          id: 'g1',
          artista: 'Bizza',
          titulo: 'Tentative - Playa de las Américas - Papagayo Tenerife',
          fecha: '20 ago 2026',
          detalle:
            'Papagayo Tenerife Av. Rafael Puig Lluvina, 2, Playa de las Américas, Santa Cruz de Tenerife, 38650, Spain —',
        },
        {
          id: 'g2',
          artista: 'Bizza',
          titulo: 'Confirmed - Ibiza - Cova Santa',
          fecha: '23 ago 2026',
          detalle:
            'Cova Santa Ibiza, PM, 07817, Spain — Performance Duration: 1h 30m Buyer Dani Clanes | PORE PORE S.L. | danilm991@gmail.com',
        },
        {
          id: 'g3',
          artista: 'Bizza',
          titulo: 'Tentative - Eivissa - Lio Ibiza',
          fecha: '05 sept 2026',
          detalle:
            'Lio Ibiza Passeig Joan Carles I, 1, 07800 Eivissa, Eivissa, Illes Balears, 07800, Spain — Lineup: Los Canarios, Bizza Buyer SERGI AARON MARI ARROYO | THE SOUL COMMUNITY SL | info@visualbeatibz.com',
        },
        {
          id: 'g4',
          artista: 'Bizza',
          titulo: 'Confirmed - Ibiza - Cova Santa - SANITY',
          fecha: '03 oct 2026',
          detalle: 'Cova Santa Ibiza, PM, 07817, Spain',
        },
        {
          id: 'g5',
          artista: 'Bizza',
          titulo: 'Confirmed - Musile di Piave - CIRQ Club',
          fecha: '31 oct 2026',
          detalle: 'CIRQ Club Via Fossetta, 72, Musile di Piave, VE, 30024, Italy',
        },
      ],
      advancing: [
        {
          id: 'a1',
          title: 'Pau Guilera @ LOAD',
          date: '01 ago 2026',
          daysLeft: 3,
          badges: ['Contrato sin firmar', 'Pago del promotor pendiente'],
        },
        {
          id: 'a2',
          title: 'Los Canarios @ Solart Fest',
          date: '01 ago 2026',
          daysLeft: 3,
          badges: ['Contrato sin firmar', 'Pago del promotor pendiente', 'Falta firmante'],
        },
        {
          id: 'a3',
          title: 'Los Canarios @ Mamarela',
          date: '02 ago 2026',
          daysLeft: 4,
          badges: ['Contrato sin firmar'],
        },
        {
          id: 'a4',
      ...
      logistics: [
        ...
        },
        {
          ...
          date: '01 ago 2026',
          daysLeft: 3,
          badges: ['Sin set times', 'Gastos sin cerrar'],
        },
        {
          id: 'l3',
          title: 'Los Canarios @ Mamarela',
          date: '02 ago 2026',
          daysLeft: 4,
          badges: ['Pendiente logística', 'Gastos sin cerrar'],
        },
        {
          id: 'l4',
          title: 'Brenda Serna @ Alcazar de San Juan',
      ...
      upcomingShows: [
        {
          ...
          badges: ['Confirmado', 'Sin liquidar'],
        },
        {
          id: 'u2',
          title: 'Los Canarios @ Solart Fest',
          date: '01 ago 2026',
          daysLeft: 3,
          location: 'San Bartolomé de Tirajana, España',
          badges: ['Confirmado', 'Sin liquidar'],
        },
        {
          id: 'u3',
          title: 'Milan @ Casa del Mar',
          date: '01 ago 2026',
          daysLeft: 3,
          location: 'Isla Santa Catalina, USA',
          badges: ['Tentative', 'Sin liquidar'],
        },
        {
          id: 'u4',
          title: 'Los Canarios @ Mamarela',
        ...
        {
          id: 'u8',
          title: 'Sera De Villalta @ Stackt Market',
          date: '29 ago 2026',
          daysLeft: 31,
        ...
        },
        {
          ...
          date: '04 sept 2026',
          daysLeft: 37,
          badges: ['Pendiente liquidar', 'Parcialmente liquidado'],
        },
        {
          id: 'u10',
          title: 'Sergio Saffe @ el Tebo',
          date: '18 sept 2026',
          daysLeft: 51,
